/* header.js — Cabecera con logo (azul/blanco según fondo) + nav/migas.
   El logo se pinta como background-image desde components.css para que Vite
   reescriba la URL relativa y funcione offline en cualquier ruta. */
 ...
 */
export function Header({ variant = "light", brandHref = "/index.html", nav = [], breadcrumb = [] } = {}) {
